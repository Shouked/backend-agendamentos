...
// Configurar SendGrid
sgMail.setApiKey('SUA_CHAVE_API_AQUI'); // Substitua pela chave do SendGrid
...
app.post('/agendamentos', async (req, res) => {
  ...
  // Enviar e-mail
  const msg = {
    to: 'SEU_EMAIL_AQUI', // Seu e-mail pessoal
    from: 'SEU_EMAIL_VERIFICADO_AQUI', // E-mail verificado no SendGrid
